namespace Mammatus.Domain.Specification
{
    public static class SpecificationExtensions
    {
        ...
        public static ISpecification<TEntity> AndAlso<TEntity>(
            this ISpecification<TEntity> leftSideSpecification,
        ...
        /// <returns>New specification</returns>
        public static ISpecification<TEntity> OrElse<TEntity>(
            this ISpecification<TEntity> leftSideSpecification,
            ISpecification<TEntity> rightSideSpecification)
        where TEntity : class
        {
